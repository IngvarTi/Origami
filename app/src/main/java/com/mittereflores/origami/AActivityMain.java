...
public class AActivityMain extends Activity implements View.OnClickListener, ViewTreeObserver.OnScrollChangedListener {
...
//                .addTestDevice("0999F05675AD0BEFAE585E82F3F576CA") // HTC HD 2
        ...
        Drawable drawable = MrVector.inflate(getResources(), R.drawable.paperplane_multi);
        if (Build.VERSION.SDK_INT >= 16) {
        ...
        Drawable drawable1 = MrVector.inflate(getResources(), R.drawable.moving_multi);
        if (Build.VERSION.SDK_INT >= 16) {
        ...
        Drawable drawable2 = MrVector.inflate(getResources(), R.drawable.christmas_multi);
        if (Build.VERSION.SDK_INT >= 16) {
...
//        Drawable drawable3 = MrVector.inflate(getResources(), R.drawable.paperplane);
//        if (Build.VERSION.SDK_INT >= 16) {
...
//        Drawable drawable4 = MrVector.inflate(getResources(), R.drawable.paperplane_a);
//        if (Build.VERSION.SDK_INT >= 16) {
...
//        Drawable drawable5 = MrVector.inflate(getResources(), R.drawable.paperplane_b);
//        if (Build.VERSION.SDK_INT >= 16) {
...
//        Drawable drawable6 = MrVector.inflate(getResources(), R.drawable.paperplane_c);
//        if (Build.VERSION.SDK_INT >= 16) {
...
//        }
    ...
    protected void onStart() {
        ...
        super.onStart();
        GoogleAnalytics.getInstance(AActivityMain.this).reportActivityStart(this);
    }
    ...
    protected void onStop() {
        // TODO Auto-generated method stub
        super.onStop();
        GoogleAnalytics.getInstance(AActivityMain.this).reportActivityStop(this);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.vectorImage:
                ...
                startActivity(new Intent(this,ActivityPlane.class), compat.toBundle());
            ...
            case R.id.vectorImage1:
                ...
                startActivity(new Intent(this,ActivityMoving.class), compat1.toBundle());
            ...
            case R.id.vectorImage2:
                ...
                startActivity(new Intent(this,ActivityChristmas.class), compat2.toBundle());
